...
const Footer = () => {
    return (
        <div className={Styles.footer}>
            ...
            <div>
                <p class="text-white pt-2"> Made with <span class={Styles.heart}>&#9825;</span> by Carlos Gutierrez Software Developer</p>
            </div>
            <div  className={Styles.right}> 
                ...
                <a href="https://github.com/cgcarlosg"><img src={github} className={Styles.logo} alt="Github Logo"/></a>
            </div>
        </div>
    )
}
